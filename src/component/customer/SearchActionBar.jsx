  ...
  setIsAddCustomerOpenExternal,
    ...
    const isAddCustomerOpen =
      typeof isAddCustomerOpenExternal === "boolean"
        ? isAddCustomerOpenExternal
        : isAddCustomerOpenInternal;
    const setIsAddCustomerOpen =
      typeof setIsAddCustomerOpenExternal === "function"
        ? setIsAddCustomerOpenExternal
        : setIsAddCustomerOpenInternal;
    ...
    const handleCustomerAdd = async (data) => {
        const payload = {
          ...
          customer_area: data.customer_area.trim(),
              ...
              >
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    {...register("customer_area", {
                      ...
                      minLength: {
                        value: 2,
                        message: "Customer area must be at least 2 characters",
                      },
                    })}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white text-zinc-900 rounded-xl border border-zinc-300 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500"
                  >
                ...
                <div>
                  ...
                  {errors.customer_priority && (
                    <span className="text-red-500 text-xs">
                      {errors.customer_priority.message}
                    </span>
                  )}
                </div>
